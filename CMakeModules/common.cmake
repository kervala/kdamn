...
MACRO(INSTALL_RESOURCES _TARGET _DIR)
  ...
  IF(WIN32)
    ...
    SET(CPACK_NSIS_HELP_LINK "http://dev.kervala.net/projects/${TARGET}")
    SET(CPACK_NSIS_URL_INFO_ABOUT "http://dev.kervala.net/projects/${TARGET}")
